...
class webService():
    ...
    def __init__(self):
        """
        Construtor que inicia o servidor web e configura os serviços necessários
        de acordo com as informações obtidas no arquivo settings.py. 
        O construtor é responsável por iniciar o flask no IP e PORTA especificados
        e configurar os erros de autenticação e de página não encontrada.
        """
    ...
    def check_auth(self, username, password):
        ...
        (Método a implementar) A implementação corrente faz autenticação somente
        do usuário admin com a senha secret, para alterar a forma de autenticação
    ...
    def requires_auth(self):
        """
        Método que verifica se o usuário e a senha recebidos via http são válidos,
        caso a autenticação seja rejeitada ele solicita nova autenticação via 
        cabeçalho http.
        """
